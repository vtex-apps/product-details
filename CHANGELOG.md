...
## [Unreleased]
### Removed
- Remove `product-quantity-selector` from interfaces. This component belongs to [store-components](https://github.com/vtex-apps/store-components/react/components/ProductQuantitySelector/README.md) now.
